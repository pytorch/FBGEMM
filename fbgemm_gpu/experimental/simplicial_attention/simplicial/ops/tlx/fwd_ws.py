...
def _run_bench(
    ...
    def fn():
        return tlx_fwd_ws(q, k1, k2, v1, v2, w1, w2)  # noqa: F821
...
def _run_bench_fa3(bs, seq_len, num_heads, num_kv_heads, head_dim, w1, w2):
    ...
    def fn():
        return fa3(q, k, v, causal=IS_CAUSAL)  # noqa: F821
...
def _bench():
    ...
    for w2 in w2s:
        for seq_len in seq_lens:
            ...
            ms_fa3, tensor_core_tflops_fa3 = _run_bench_fa3(
                bs, seq_len, num_heads, num_kv_heads, head_dim, w1, w2
            )
            print(
                f"{bs=} {seq_len=} {num_heads=} {head_dim=} {w1=} {w2=} | latency ms={ms:.3f} tensor_core_tflops={tensor_core_tflops:.3f} | latency ms (FA3)={ms_fa3:.3f} tensor_core_tflops (FA3)={tensor_core_tflops_fa3:.3f}"
            )
