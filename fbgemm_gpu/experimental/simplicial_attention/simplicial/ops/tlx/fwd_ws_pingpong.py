...
def _tlx_fwd_kernel(
    ...
    with tlx.async_tasks():
        ...
        with tlx.async_task("default"):
            ...
            # - Q[c0], K2[b0], Q[c1], V2[b0]
            # - K2[b1], V2[b1], K2[b0], V2[b0], ....

            # load Q[c0]
            cid = 0
            q_full = tlx.local_view(q_fulls, cid)
            tlx.barrier_expect_bytes(q_full, 2 * BLOCK_M_SPLIT * HEAD_DIM)  # bfloat16
...
def _run_bench(
    ...
    def fn():
        return tlx_fwd_ws_pingpong(q, k1, k2, v1, v2, w1, w2)  # noqa: F821
    ...
    tensor_core_tflops = (
        get_simplicial_tensor_core_tflops(
