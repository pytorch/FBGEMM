...
import pytest
import torch
from simplicial.ops.tlx.fwd_ws_pipelined import tlx_fwd_ws_pipelined
...
def test_tlx_fwd_ws_pipelined(B, N, H, D, w1, w2):
    ...
    # Test the pipelined tlx_fwd_ws_pipelined kernel
    out_pipelined, m = tlx_fwd_ws_pipelined(Q, K1, K2, V1, V2, w1=w1, w2=w2)
