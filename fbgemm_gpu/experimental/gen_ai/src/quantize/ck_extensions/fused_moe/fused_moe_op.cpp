...
at::Tensor fused_moe_impl(
    ...
    const at::optional<at::Tensor> input_scales = {}, // [tokens]
    const at::optional<at::Tensor> gate_up_scales = {}, // [intermediate_size]
    const at::optional<at::Tensor> down_scales = {}, // [intermediate_size]
    const at::optional<at::Tensor> smooth_scales = {}, // [intermediate_size]
    int64_t block_m = 32,
    bool gate_only = true,
