...
#include <iostream>
#include "../../hip/cutlass_blackwell_fmha/reference/reference_abs_error.hpp"

#include <ATen/core/dispatch/Dispatcher.h>
#include <signal.h>
#include "../../hip/cutlass_blackwell_fmha/collective/fmha_fusion.hpp"
#include "../../hip/cutlass_blackwell_fmha/collective/sm100_fmha_fwd_epilogue_tma_warpspecialized.hpp"
#include "../../hip/cutlass_blackwell_fmha/collective/sm100_fmha_fwd_mainloop_tma_warpspecialized.hpp"
#include "../../hip/cutlass_blackwell_fmha/device/fmha.hpp"
#include "../../hip/cutlass_blackwell_fmha/kernel/fmha_tile_scheduler.hpp"
#include "../../hip/cutlass_blackwell_fmha/kernel/sm100_fmha_fwd_kernel_tma_warpspecialized.hpp"

#include "../../hip/cutlass_blackwell_fmha/blackwell_gen_interface.hpp"
#include "../../hip/cutlass_blackwell_fmha/collective/fmha_fusion.hpp"
#include "../../hip/cutlass_blackwell_fmha/device/fmha_device_bwd.hpp"
...
struct TensorWrapper {
  ...
  void reset(size_t size, size_t offset = 0) {
    tensor_ = at::empty(
        ...
        at::TensorOptions()
            ...
            .device(at::Device(at::kCUDA, at::hip::current_device())));
    size_ = size;
    offset_ = offset;
  }
  ...
  void copy_from_device(const at::Tensor& tensor) {
    ...
    auto ret = hipMemcpyAsync(
        get(),
        tensor.data_ptr(),
        tensor.numel() * sizeof(T),
        hipMemcpyDefault,
        at::hip::getCurrentHIPStreamMasqueradingAsCUDA());
    TORCH_CHECK(ret == hipSuccess);
  }
};
...
static void launch_fmha_op(const typename Operation::Arguments& arguments) {
  ...
  // Run
  status = op.run(at::hip::getCurrentHIPStreamMasqueradingAsCUDA());
  TORCH_CHECK(
      status == cutlass::Status::kSuccess,
