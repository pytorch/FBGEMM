...
def memory_efficient_attention_forward_meta(
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
    attn_bias: Optional[Union[torch.Tensor, AttentionBias]] = None,
...
@torch.library.impl("xformer::memory_efficient_attention_forward_with_bias", "Meta")
def memory_efficient_attention_forward_meta(  # noqa F811
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
...
# torch.compile has issue when tracing through op dispatch and ensure_op_support
# so provide a wrapper to register it as a custom torch library op.
@torch.library.impl("xformer::memory_efficient_attention_forward_with_bias", "CUDA")
def memory_efficient_attention_forward_torch_wrapper_with_bias(
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
    attn_bias: Union[torch.Tensor, AttentionBias],
