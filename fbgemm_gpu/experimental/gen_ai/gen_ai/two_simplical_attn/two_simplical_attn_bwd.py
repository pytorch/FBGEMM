...
TWO_SIMPLICAL_AUTOTUNE = os.getenv("TWO_SIMPLICAL_AUTOTUNE", "0") == "1"


def get_configs():
    if TWO_SIMPLICAL_AUTOTUNE:
        return [
            Config(
                {
...
@triton.jit
def two_simplical_attn_bwd_kv1_kernel(
    Q_ptr,  # [b, s, k, h]
    K1_ptr,  # [b, s, k, h]
    K2_ptr,  # [b, s, k, h]
    V1_ptr,  # [b, s, k, h]
...
def two_simplical_attn_bwd_kv1_triton(
    q,
    k1,
    k2,
    v1,
    ...
    two_simplical_attn_bwd_kv1_kernel[grid](
        q,
        k1,
        k2,
        v1,
...
@triton.jit
def two_simplical_attn_bwd_kv2q_kernel(
    Q_ptr,  # [b, s, k, h]
    K1_ptr,  # [b, s, k, h]
    K2_ptr,  # [b, s, k, h]
    V1_ptr,  # [b, s, k, h]
...
def two_simplical_attn_bwd_kv2q_triton(
    q,
    k1,
    k2,
    v1,
    ...
    for is_second_pass in [False, True]:
        two_simplical_attn_bwd_kv2q_kernel[grid](
            q,
            k1,
            k2,
            v1,
