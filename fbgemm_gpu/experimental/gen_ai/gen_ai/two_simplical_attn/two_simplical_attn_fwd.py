...
def _gqa_pack_fwd_kernel(
    ...
    """GQA two simplical attention fwd kernel. Assume TP=num_kv so kernel is called per kv_group."""
...
def two_simplical_attn_fwd(q, k1, k2, v1, v2, w1, w2, k2_bias=None, v2_bias=None):
    """Two simplical attention kernel with GQA packing.
    L = q @ k1 X k2
