...
// TODO: remove unused args. Add device arg.
Tensor merge_pooled_embeddings(
    std::vector<Tensor> ad_pooled_embeddings,
    std::vector<Tensor> user_pooled_embeddings, // not used
...
TORCH_LIBRARY_FRAGMENT(fbgemm, m) {
  m.def(
      "merge_pooled_embeddings(Tensor[] ad_pooled_embeddings, Tensor[] user_pooled_embeddings, Tensor batch_indices) -> Tensor");
