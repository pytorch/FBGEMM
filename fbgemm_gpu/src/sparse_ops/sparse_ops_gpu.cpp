...
TORCH_LIBRARY_IMPL(fbgemm, CUDA, m) {
  ...
  DISPATCH_TO_CUDA(
      "group_index_select_dim0_forward_impl", fbgemm_gpu::forward_impl);
  DISPATCH_TO_CUDA(
      "group_index_select_dim0_backward_impl", fbgemm_gpu::backward_impl);
  DISPATCH_TO_CUDA(
      "group_index_select_dim0", fbgemm_gpu::group_index_select_dim0);
  DISPATCH_TO_CUDA(
      "group_index_select_dim0_autograd_impl",
