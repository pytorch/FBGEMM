...
filestore_available: bool = False
eeg_estimator_available: bool = False
try:
...
class TBEBenchmarkParamsReporter:
    ...
    def __init__(
        ...
        assert filestore_available, "FileStore is not available"
        assert eeg_estimator_available, "EEG estimator is not available"
