...
Args:
    ...
    permute_list (Tensor): A tensor that describes the permute position
        of each feature. `permute_list[i]` represents the feature
        `permute_list[i]` that is being permuted to position `i`
