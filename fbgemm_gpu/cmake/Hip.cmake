...
if(HIP_FOUND)
  ...
  if(ROCM_VERSION_DEV VERSION_GREATER_EQUAL "6.0.0")
    ...
    set(AMD_DEVICE_LIBS_DIR ${ROCM_PATH}/lib/cmake/AMDDeviceLibs)
  ...
  list(APPEND CMAKE_PREFIX_PATH  ${hip_DIR})
  list(APPEND CMAKE_PREFIX_PATH  ${AMD_DEVICE_LIBS_DIR})
  list(APPEND CMAKE_PREFIX_PATH  ${amd_comgr_DIR})

  find_package_and_print_version(hip REQUIRED)
  find_package_and_print_version(hsa-runtime64 REQUIRED)
  find_package_and_print_version(AMDDeviceLibs REQUIRED)
