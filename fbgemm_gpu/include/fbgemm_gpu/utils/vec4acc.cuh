...
struct Vec4AccT {
  ...
  DEVICE_INLINE void store([[maybe_unused]] uint8_t* ptr) {
  ...
  DEVICE_INLINE void add([[maybe_unused]] const uint8_t* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void fma(
      [[maybe_unused]] const uint8_t* ptr,
      [[maybe_unused]] const float weight) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void add([[maybe_unused]] const c10::Float8_e4m3fn* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void fma(
      [[maybe_unused]] const c10::Float8_e4m3fn* ptr,
      [[maybe_unused]] const float weight) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void add([[maybe_unused]] const c10::Float8_e4m3fnuz* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void fma(
      [[maybe_unused]] const c10::Float8_e4m3fnuz* ptr,
      [[maybe_unused]] const float weight) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }
...
struct Vec4StepT<STEP, uint8_t> : Vec4AccT {
  ...
  DEVICE_INLINE void load(
      [[maybe_unused]] const uint8_t* ptr,
      [[maybe_unused]] const uint32_t idx) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }
  ...
  DEVICE_INLINE void weighted_sum(
      [[maybe_unused]] const float* const weights,
      [[maybe_unused]] const uint32_t idx_shift,
      [[maybe_unused]] const uint32_t idx_scale) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void index_add([[maybe_unused]] uint32_t idx) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void index_fma(
      [[maybe_unused]] uint32_t idx,
      [[maybe_unused]] const float weight) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }
  ...
  DEVICE_INLINE void index_store(
      [[maybe_unused]] uint32_t idx,
      [[maybe_unused]] float4* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }

  DEVICE_INLINE void index_store(
      [[maybe_unused]] uint32_t idx,
      [[maybe_unused]] float2* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }
...
struct Vec4StepT<STEP, c10::Float8_e4m3fn> : Vec4AccT {
  ...
  DEVICE_INLINE void index_store(
      [[maybe_unused]] uint32_t idx,
      [[maybe_unused]] c10::Float8_e4m3fn* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }
...
struct Vec4StepT<STEP, c10::Float8_e4m3fnuz> : Vec4AccT {
  ...
  DEVICE_INLINE void index_store(
      [[maybe_unused]] uint32_t idx,
      [[maybe_unused]] c10::Float8_e4m3fnuz* ptr) {
    CUDA_KERNEL_ASSERT(false && "Unsupported Vec4 operation");
  }
