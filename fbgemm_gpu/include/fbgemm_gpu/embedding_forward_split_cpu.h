...
struct HyperCompressedSparseColumn {
  ...
  fbgemm::aligned_unique_ptr<int> column_segment_indices; // length num_non_zero_columns
  fbgemm::aligned_unique_ptr<int> column_segment_ids; // length num_non_zero_columns
  fbgemm::aligned_unique_ptr<int> row_indices; // length column_ptr[num_non_zero_columns]
  fbgemm::aligned_unique_ptr<float> weights; // length column_ptr[num_non_zero_columns]
};
