...
class FBGEMMGPUQuantizeOpsTest : public ::testing::Test {
 protected:
  ...
  static void SetUpTestCase() {
    input = new float[nrows * ncols]{0.4962565899,
                                     0.7682217956,
                                     0.0884774327,
                                     0.1320304871,
                                     0.3074228168,
    ...
    dequantize_fuse8bit_output_ref = new float[nrows * ncols]{0.4972138405,
                                                              0.7697047591,
                                                              0.0884774327,
                                                              0.1328364164,
                                                              0.3071038723,
                                                              ...
                                                              0.2950229049,
                                                              0.5174863935};
    quantize_fusenbit_output_ref = new uint8_t[nrows * ncols]{216,
                                                              16,
                                                              164,
                                                              247,
                                                              229,
                                                              ...
                                                              183,
                                                              37};
    dequantize_fusenbit_output_ref = new float[nrows * ncols]{0.5194091797,
                                                              0.7887268066,
                                                              0.0885009766,
                                                              0.1423645020,
                                                              0.3039550781,
