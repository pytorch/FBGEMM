            ...
            DISPATCH_OPTIMAL_KERNEL(max_D, [&] {
                ...
                DISPATCH_PLACEHOLDER_TYPES(
                  ...
                  [&] {
                    ...
                    const bool dev_is_warp64 = at::cuda::warp_size() == 64;

                    if (use_hip_kernel && dev_is_warp64 && !mixed_D && !cached && supported_weights_type && supported_grad_type && same_precision && rocm::is_supported_cdna())
                    {
