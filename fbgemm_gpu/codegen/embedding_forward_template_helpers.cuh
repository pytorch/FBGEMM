...
__device__ inline int32_t padded_D(const int32_t dim, const fbgemm_gpu::SparseType weight_ty) {
  switch(weight_ty){
    case fbgemm_gpu::SparseType::FP32: return dim;
    case fbgemm_gpu::SparseType::FP16: return dim;
    case fbgemm_gpu::SparseType::FP8: return dim;
    case fbgemm_gpu::SparseType::INT8: return dim + 4;
    case fbgemm_gpu::SparseType::INT4: return dim + 8;
    case fbgemm_gpu::SparseType::INT2: return dim + 16;
    default: return 0;
  }
}
