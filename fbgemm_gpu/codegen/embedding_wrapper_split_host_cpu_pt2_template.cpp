...
TORCH_LIBRARY_FRAGMENT(fbgemm, m) {
    ...
    %}
    DISPATCH_TO_CPU("{{ embedding_codegen_forward_op }}", {{ embedding_codegen_forward_op }}_cpu);
    {%- else %}
    ...
    %}
    DISPATCH_TO_CPU("{{ embedding_codegen_backward_op }}", {{ embedding_codegen_backward_op }}_cpu);
    {%- endif %}
    {%- endfor %} {#-/*for weighted*/#}
}
