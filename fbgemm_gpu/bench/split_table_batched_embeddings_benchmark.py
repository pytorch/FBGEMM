...
def uvm(
    ...
    T_gpu = T - T_uvm
    L_uvm = uvm_bag_size
    eval_conflict_misses = no_conflict_misses or all_conflict_misses
    ...
    emb_uvm = SplitTableBatchedEmbeddingBagsCodegen(
        ...
        gather_uvm_cache_stats=eval_conflict_misses,
    ).cuda()
    ...
    # pyre-ignore[2, 53]
    def run_bench(indices, offsets, per_sample_weights) -> None:
        if eval_conflict_misses:
            # Set uvm_cache_stats
