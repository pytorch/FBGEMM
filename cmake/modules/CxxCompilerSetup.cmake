...
# Ensure C++ standard is at least CXX_VERSION (C++20)
if(CMAKE_CXX_STANDARD LESS ${CXX_VERSION} OR CMAKE_CXX_STANDARD EQUAL 98)
  message(FATAL_ERROR
    "FBGEMM requires C++${CXX_VERSION} or newer, but CMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} was specified.")
endif()
