...
#define INSTANTIATE_SPMDM_BASE(                                             \
    INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, BAG, PREFETCH)                       \
  template bool                                                             \
  EmbeddingSpMDM8Bit_Sve<INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, BAG, PREFETCH>( \
      const int64_t block_size,                                             \
      const int64_t output_size,                                            \
      const int64_t index_size,                                             \
      const int64_t data_size,                                              \
...
#define INSTANTIATE_SPMDM_PREFETCH(INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, BAG) \
  INSTANTIATE_SPMDM_BASE(INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, BAG, true)     \
  INSTANTIATE_SPMDM_BASE(INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, BAG, false)

#define INSTANTIATE_SPMDM_BAG(INDEX_TYPE, OFFSET_TYPE, OUT_TYPE)      \
  INSTANTIATE_SPMDM_PREFETCH(INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, true) \
  INSTANTIATE_SPMDM_PREFETCH(INDEX_TYPE, OFFSET_TYPE, OUT_TYPE, false)

#define INSTANTIATE_SPMDM_OUT_T(INDEX_TYPE, OFFSET_TYPE) \
  INSTANTIATE_SPMDM_BAG(INDEX_TYPE, OFFSET_TYPE, float)  \
  INSTANTIATE_SPMDM_BAG(INDEX_TYPE, OFFSET_TYPE, float16)
