...
INSTANTIATE_SPMDM_OFFSET_T(float, int32_t)
INSTANTIATE_SPMDM_OFFSET_T(float, int64_t)
INSTANTIATE_SPMDM_OFFSET_T(float16, int32_t)
INSTANTIATE_SPMDM_OFFSET_T(float16, int64_t)
