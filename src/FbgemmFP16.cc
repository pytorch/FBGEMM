...
static constexpr knl_ptr kernel_avx512_256[] = {nullptr,
                                        gemmkernel_1x2_Avx2_fA0fB0fC0,
                                        gemmkernel_2x2_Avx2_fA0fB0fC0,
                                        gemmkernel_3x2_Avx2_fA0fB0fC0,
                                        gemmkernel_4x2_Avx2_fA0fB0fC0,
                                        gemmkernel_5x2_Avx2_fA0fB0fC0,
                                        gemmkernel_6x2_Avx2_fA0fB0fC0,
                                        gemmkernel_7x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_8x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_9x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_10x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_11x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_12x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_13x2_Avx512_256_fA0fB0fC0,
                                        gemmkernel_14x2_Avx512_256_fA0fB0fC0};
...
static constexpr const KernelInfo::knl_ptr* kernelInfo[] = {
    KernelInfo::kernel_avx2,
    KernelInfo::kernel_avx512,
    KernelInfo::kernel_avx512_256,
    KernelInfo::kernel_avx512,    // AVX512_VNNI
};
static constexpr __decltype(KernelInfo::partition_avx2)  partitionInfo[] = {
    KernelInfo::partition_avx2,
    KernelInfo::partition_avx512,
    KernelInfo::partition_avx512,
    KernelInfo::partition_avx512, // AVX512_VNNI
};
}
...
FBGEMM_API void cblas_gemm_compute(
  ...
  int simd_width = (iset == fbgemm::avx512 || iset == fbgemm::avx512_vnni) &&
      (Bp.blockColSize() == 16 * kernel_ncol_blocks) ? 16 : 8;
  ...
  auto const isaIndex = simd_width == 16 || iset == avx2 ? iset : avx512_256;
  const funcptr_fp16* kernels = KernelInfo::kernelInfo[isaIndex];
  const auto& partition = KernelInfo::partitionInfo[isaIndex];
  ...
  for (auto m0 = i_begin; m0 < i_end; m0 += mb_max) {
    ...
    for (auto k_ind = 0; k_ind < k; k_ind += Bp.blockRowSize()) {
      ...
      auto m1 = m0;
      auto const num_cycles = partition[0].size();
