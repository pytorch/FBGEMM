...
void NOINLINE gemmkernel_8x1_Neon_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  ...
  __asm__ __volatile__(
      ...
      "mov x21, #0x4\n"
      "mov x22, #0x8\n"
      "ldr x17, [%x[gp], %[offsetof_ldc]]\n"
      "ldr x11, [%x[gp], %[offsetof_b_block_cols]]\n"
      "ldr x14, [%x[gp], %[offsetof_lda]]\n"
      "fmov %w[gp], s16\n"
      "lsl x20, x16, #2\n"
      "whilelo p0.s, XZR, x16\t\n"
      "lsl x16, x16, #4\n"
      "whilelo p1.s, x21, x20\t\n"
      "whilelo p2.s, x22, x20\t\n"
      ...
      "cbz x16, 9f\n"
      "ldr q13, [x10]\t\n"
      "ld1rqw { z0.s }, p0/z, [x27, #0x10]\t\n"
      "movi v14.16b, #0x0\n"
      "movi v10.16b, #0x0\n"
      "ld1rqw { z1.s }, p0/z, [x26, #0x10]\t\n"
      "ld1rqw { z2.s }, p0/z, [x25, #0x10]\t\n"
      "ld1rqw { z8.s }, p1/z, [x10, #0x10]\t\n"
      "ld1rqw { z3.s }, p0/z, [x24, #0x10]\t\n"
      "ld1rqw { z4.s }, p0/z, [x23, #0x10]\t\n"
      "ld1rqw { z5.s }, p0/z, [x22, #0x10]\t\n"
      "ld1rqw { z6.s }, p0/z, [x21, #0x10]\t\n"
      "fmlal v14.4s, v13.4h, v15.4h\n"
      "fmlal2 v10.4s, v13.4h, v15.4h\n"
      "ld1rqw { z7.s }, p0/z, [x20, #0x10]\t\n"
      "movi v12.16b, #0x0\n"
      "ld1rqw { z9.s }, p2/z, [x10, #0x20]\t\n"
      "movi v13.16b, #0x0\n"
      "movi v11.16b, #0x0\n"
      "add x10, x10, x16\n"
      "fmlal v12.4s, v8.4h, v15.4h\n"
      ...
      "fmla v29.4s, v13.4s, v6.s[1]\n"
      "fmla v31.4s, v13.4s, v7.s[1]\n"
      "fmlal2 v14.4s, v9.4h, v15.4h\n"
      "fmla v16.4s, v11.4s, v0.s[2]\n"
      "fmla v18.4s, v11.4s, v1.s[2]\n"
      "fmla v20.4s, v11.4s, v2.s[2]\n"
      "fmla v22.4s, v11.4s, v3.s[2]\n"
      "fmla v24.4s, v11.4s, v4.s[2]\n"
      "fmla v26.4s, v11.4s, v5.s[2]\n"
      "fmla v28.4s, v11.4s, v6.s[2]\n"
      "fmla v30.4s, v11.4s, v7.s[2]\n"
      "fmla v17.4s, v14.4s, v0.s[2]\n"
      "fmla v19.4s, v14.4s, v1.s[2]\n"
      "fmla v21.4s, v14.4s, v2.s[2]\n"
      "fmla v23.4s, v14.4s, v3.s[2]\n"
      "fmla v25.4s, v14.4s, v4.s[2]\n"
      "fmla v27.4s, v14.4s, v5.s[2]\n"
      "fmla v29.4s, v14.4s, v6.s[2]\n"
