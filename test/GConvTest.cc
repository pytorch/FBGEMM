...
static vector<conv_param_t<>> GetShapes_() {
  vector<conv_param_t<>> shapes = {
      ...
      // This line is not optimized and will fallback to slow path
      ...
      // Test strided convs
      conv_param_t<>(1, 32, 32, {7, 7}, 8, {3, 3}, {2, 2}, {1, 1, 1, 1}),
      conv_param_t<>(1, 64, 64, {7, 8}, 8, {3, 3}, {2, 2}, {1, 1, 1, 1}),
      conv_param_t<>(1, 64, 64, {8, 7}, 8, {3, 3}, {2, 2}, {1, 1, 1, 1}),
      conv_param_t<>(1, 128, 128, {8, 8}, 8, {3, 3}, {2, 2}, {1, 1, 1, 1}),
